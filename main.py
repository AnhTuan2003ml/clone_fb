...
def setup_browser():
    ...
    """Thiết lập trình duyệt và master profile"""
    ...
    print("  \033[1;33m[1]\033[0m  Chọn profile Chrome sẵn có làm MASTER")
    print("  \033[1;33m[2]\033[0m  Mở trình duyệt master hiện tại")
    print("  \033[1;33m[3]\033[0m  Kiểm tra cấu hình trình duyệt")
    print("  \033[1;33m[0]\033[0m  Quay lại")
    
    choice = get_input("\nChọn chức năng: ", allow_empty=True)
